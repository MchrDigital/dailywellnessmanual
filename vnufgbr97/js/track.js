...
var campaignID = "69c4adde9ab109815d1a80e0";
...
var initialSrc = "https://wyw.healthy-future.site/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("wyw.healthy-future.site/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://wyw.healthy-future.site/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://wyw.healthy-future.site/view?clickid=" + rtkClickID)
        xhrTrack.send();
